...
import { Check, Star, Zap, Crown, Plus, Palette, Edit, Database, Wrench } from 'lucide-react';
  ...
  const plans = [
    {
      ...
      bestFor: "food trucks, nail salons, small shops that just need a web presence.",
    ...
    },
    {
      ...
      bestFor: "restaurants, barber shops, boutiques ready to stand out online.",
    ...
    },
    {
      ...
      bestFor: "established businesses ready to grow their customer base online.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto">
            Choose the perfect package for your business. All plans include modern design, 
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-20">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`relative bg-slate-800 rounded-2xl border ${plan.borderColor} p-8 w-full md:w-96 lg:w-80 xl:w-96 transition-all hover:transform hover:scale-105 ${
            ...
            >
              ...
              <div className="mb-8 p-4 bg-slate-700/50 rounded-lg">
                <div className="text-sm font-semibold text-slate-300 mb-1">Best for:</div>
                <div className="text-slate-400 text-sm">{plan.bestFor}</div>
              </div>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    {addon.description && (
                      <p className="text-sm text-slate-400 mb-1">{addon.description}</p>
                    )}
                    <div className={`font-bold ${addon.color}`}>{addon.price}</div>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="text-center bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-8 border border-slate-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 px-8 py-3 rounded-lg font-semibold transition-all transform hover:scale-105">
